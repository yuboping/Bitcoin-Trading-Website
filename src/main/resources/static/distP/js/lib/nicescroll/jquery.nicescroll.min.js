    ...
    var v = window.MutationObserver || window.WebKitMutationObserver || !1,
        ...
        R = function(k, c) {
            ...
            this.getOffset = function() { if (a.isfixed) { var b = a.win.offset(),
                    ...
                    b.top -= g.top;
                    b.left -= g.left; return b } b = a.win.offset(); if (!a.viewport) return b;
            ...
            this.init = function() {
                ...
                if (!a.ispage || !e.cantouch && !e.isieold && !e.isie9mobile) {
                                ...
                                if (!a.railslocked) {
                                    ...
                                    if (e.hasmstouch)
                                        for (c = b.target ? b.target : !1; c;) { var g = f(c).getNiceScroll(); if (0 < g.length && g[0].me == a.me) break; if (0 < g.length) return !1; if ("DIV" == c.nodeName && c.id == a.id) break;
                                            c = c.parentNode ? c.parentNode : !1 } a.cancelScroll();
                            ...
                            a.ontouchmove = function(b, c) {
                                ...
                                if (2 == a.rail.drag.pt) {
                                    ...
                                    if (a.rail.drag.dl) g = !0, "v" == a.rail.drag.dl ? l = a.rail.drag.sl : "h" == a.rail.drag.dl && (k = a.rail.drag.st);
                                            ...
                                            d > z && (a.rail.drag.dl = "f", f("body").scrollLeft(f("body").scrollLeft())) } } a.synched("touchmove", function() {
                            ...
                            var p = function(b) {
                                if (a.selectiondrag) {
                                    if (b) { var c = a.win.outerHeight();
                                        ...
                                        0 < b && b < c && (b = 0);
                                        b >= c && (b -= c);
                                        a.selectiondrag.df = b } 0 != a.selectiondrag.df && (a.doScrollBy(2 * -Math.floor(a.selectiondrag.df / 6)), a.debounced("doselectionscroll",
                                        function() { p() }, 50))
                                }
                            };
                    ...
                    if (e.ischrome && !a.ispage && !a.haswrapper) { var r = a.win.attr("style"),
                        ...
                        a.win.css("width", c);
                        a.synched("chromefix", function() { a.win.attr("style", r) }) } a.onAttributeChange = function(b) {
                ...
                if ("IFRAME" == this.doc[0].nodeName) {
                    var M = function() {
                        ...
                        if (!e.isios && a.opt.iframeautoresize && !a.isiframe) { a.win.scrollTop(0);
                            ...
                            a.doc.height(g) } a.lazyResize(30);
            ...
            this.showCursor = function(b, c) {
                ...
                if (a.rail) {
                    ...
                    if (a.cursorh) { var d = a.hasreversehr ? a.scrollvaluemaxw - a.scroll.x : a.scroll.x;!a.rail.align && a.rail.visibility ? a.cursorh.css({ width: a.cursorwidth, left: d + a.rail.width }) : a.cursorh.css({ width: a.cursorwidth, left: d });
                        a.cursoractive = !0 } a.zoom && a.zoom.stop().css({ opacity: a.opt.cursoropacitymax })
                }
            };
            ...
            this.remove = function() {
                ...
                for (var b = 0; b < a.saved.css.length; b++) { var c = a.saved.css[b];
                    c[0].css(c[1], "undefined" == typeof c[2] ? "" : c[2]) } a.saved = !1;
            ...
            this.doScrollBy = function(b, c) {
                ...
                if (a.bouncescroll) { var e = Math.round(a.view.h / 2);
                    d < -e ? d = -e : d > a.page.maxh + e && (d = a.page.maxh + e) } a.cursorfreezed = !1;
                e = a.getScrollTop(!0);
            ...
            this.doScrollLeftBy = function(b, c) { var d = 0,
                    ...
                    d < -e ? d = -e : d > a.page.maxw + e && (d = a.page.maxw + e) } a.cursorfreezed = !1;
            ...
            this.doZoomIn = function(b) {
                if (!a.zoomactive) {
                    ...
                    for (h in c) { var k = c[h];
                        a.zoomrestore.style[k] = "undefined" != typeof d[k] ? d[k] : "" } a.zoomrestore.style.width = a.win.css("width");
